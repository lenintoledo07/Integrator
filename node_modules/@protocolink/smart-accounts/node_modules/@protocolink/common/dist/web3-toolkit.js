...
class Web3Toolkit {
    ...
    get multicall2Iface() {
        if (!this._multicall2Iface) {
            this._multicall2Iface = contracts_1.Multicall2__factory.createInterface();
        }
        return this._multicall2Iface;
    }
    get multicall2() {
        if (!this._multicall2) {
            this._multicall2 = contracts_1.Multicall2__factory.connect(this.network.multicall2Address, this.provider);
        }
