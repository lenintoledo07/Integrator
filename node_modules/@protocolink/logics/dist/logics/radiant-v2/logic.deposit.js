...
class DepositLogic extends core.Logic {
    async getTokenList() {
        ...
        for (const reserveToken of reserveTokens) {
            if (reserveToken.asset.isWrapped) {
                tokenList.push([reserveToken.asset.unwrapped, reserveToken.rToken]);
            }
            tokenList.push([reserveToken.asset, reserveToken.rToken]);
        }
        return tokenList;
    }
    async quote(params) {
...
DepositLogic.id = 'deposit';
DepositLogic.protocolId = 'radiant-v2';
DepositLogic.supportedChainIds = configs_1.supportedChainIds;
