...
class RepayLogic extends core.Logic {
    ...
    async quote(params) {
        ...
        const service = new service_1.Service(this.chainId, this.provider);
        const { currentStableDebt, currentVariableDebt } = await service.protocolDataProvider.getUserReserveData(tokenIn.wrapped.address, borrower);
...
RepayLogic.id = 'repay';
RepayLogic.protocolId = 'radiant-v2';
