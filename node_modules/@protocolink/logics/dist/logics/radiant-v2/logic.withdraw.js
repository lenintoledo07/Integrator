    ...
    async getTokenList() {
        ...
        for (const reserveToken of reserveTokens) {
            if (reserveToken.asset.isWrapped) {
                tokenList.push([reserveToken.rToken, reserveToken.asset.unwrapped]);
            }
            tokenList.push([reserveToken.rToken, reserveToken.asset]);
        }
        return tokenList;
    }
    async quote(params) {
...
WithdrawLogic.protocolId = 'radiant-v2';
