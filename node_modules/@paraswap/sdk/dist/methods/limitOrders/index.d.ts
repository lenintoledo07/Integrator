...
export declare type LimitOrderHandlers<T> = SubmitLimitOrderFuncs & BuildLimitOrderFunctions & SignLimitOrderFunctions & PostLimitOrderFunctions & GetLimitOrdersFunctions & GetLimitOrdersContractFunctions & BuildLimitOrdersTxFunctions & CancelLimitOrderFunctions<T> & ApproveTokenForLimitOrderFunctions<T> & FillOrderDirectlyFunctions<T>;
