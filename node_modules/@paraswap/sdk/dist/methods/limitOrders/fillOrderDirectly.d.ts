...
export declare type FillOrderDirectlyFunctions<T> = {
    fillOrderDirectly: FillOrderDirectly<T>;
};
export declare type FillOrderDirectly<T> = (order: OrderData, signature: string, overrides?: TxSendOverrides, signal?: AbortSignal) => Promise<T>;
