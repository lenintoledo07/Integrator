...
import type { Address, ConstructProviderFetchInput, TxSendOverrides } from '../../types';
declare type ApproveNFT<T> = (tokenAddress: Address, overrides?: TxSendOverrides) => Promise<T>;
export declare type ApproveTokenForNFTOrderFunctions<T> = {
