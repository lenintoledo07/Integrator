...
var _excluded$4 = ["srcToken", "destToken"],
    _excluded2$2 = ["route"],
    _excluded3 = ["options"],
    _excluded4 = ["excludePricingMethods", "excludeContractMethods", "includeContractMethods", "partner", "includeDEXS", "excludeDEXS", "excludePools"];
...
function buildOrderData(_ref) {
  ...
  // or 0 for limitOrders, so that anyone can be the taker of the Order
  var nonceAndMeta = (BigInt(takerInNonce) + (BigInt(nonce) << BigInt(160))).toString(10);
  var taker; // contractTaker overrides always
...
function constructFillOrderDirectly(options) {
  ...
  var fillOrderDirectly = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(order, signature, overrides, signal) {
      var AugustusRFQ, sanitizedOrder, res;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
    ...
    return function fillOrderDirectly(_x, _x2, _x3, _x4) {
      return _ref.apply(this, arguments);
    };
  }();
...
var constructBuildLimitOrderTx = function constructBuildLimitOrderTx(_ref) {
  ...
  var _constructGetRate = constructGetRate({
    ...
    fetcher: fetcher
      ...
      getSwapAndLimitOrderRate = _constructGetRate.getRate; //  returns priceRoute that would allow to swap from srcToken to destToken(=order.takerAsset) followed by filling limit orders
